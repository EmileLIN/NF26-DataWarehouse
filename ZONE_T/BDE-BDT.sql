...
--Insertion for date
INSERT INTO F_BDT_DATE(Trade_Date) SELECT DISTINCT TICKET_DATE FROM F_BDE_VENTE;
...
--Delete all the data and reinsert data
TRUNCATE TABLE f_bdt_catalogue;
TRUNCATE TABLE f_bdt_date;
TRUNCATE TABLE f_bdt_magasin;
