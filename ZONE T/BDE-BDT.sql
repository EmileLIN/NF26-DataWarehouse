...
ALTER TABLE F_BDT_CATALOGUE ENABLE CONSTRAINT SYS_C00281329 EXCEPTIONS INTO EXCEPTION_RECORDS;
ALTER TABLE F_BDT_CATALOGUE ENABLE CONSTRAINT SYS_C00281330 EXCEPTIONS INTO EXCEPTION_RECORDS;

--F_BDT_DATE
ALTER TABLE F_BDT_DATE ENABLE CONSTRAINT CHECK_DATE EXCEPTIONS INTO EXCEPTION_RECORDS;
ALTER TABLE F_BDT_DATE ENABLE CONSTRAINT SYS_C00281467 EXCEPTIONS INTO EXCEPTION_RECORDS;
ALTER TABLE F_BDT_DATE ENABLE CONSTRAINT SYS_C00281468 EXCEPTIONS INTO EXCEPTION_RECORDS;
...
ALTER TABLE F_BDT_MAGASIN ENABLE CONSTRAINT SYS_C00281395 EXCEPTIONS INTO EXCEPTION_RECORDS;     -- Contraint for the primary key Magasin_Id
ALTER TABLE F_BDT_MAGASIN ENABLE CONSTRAINT SYS_C00281396 EXCEPTIONS INTO EXCEPTION_RECORDS;

--F_BDT_VENTE，this one should be at last place because of its foreign keys
ALTER TABLE F_BDT_VENTE ENABLE CONSTRAINT SYS_C00281595 EXCEPTIONS INTO EXCEPTION_RECORDS;
ALTER TABLE F_BDT_VENTE ENABLE CONSTRAINT SYS_C00281596 EXCEPTIONS INTO EXCEPTION_RECORDS;
ALTER TABLE F_BDT_VENTE ENABLE CONSTRAINT SYS_C00281597 EXCEPTIONS INTO EXCEPTION_RECORDS;
ALTER TABLE F_BDT_VENTE ENABLE CONSTRAINT SYS_C00281598 EXCEPTIONS INTO EXCEPTION_RECORDS;
*/
...
--CHECK_DATE
--CHECK_POPULATION
--SYS_C00281597  The foreign key Product In table F_BDT_VENTE
--SYS_C00281598  The foreign key Shop In table F_BDT_VENTE
*/
...
--Step 7  Implements the first version of methods which return simply the values non-tranformed
